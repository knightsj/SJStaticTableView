#
#  Be sure to run `pod spec lint SJStaticTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Sun Shijie"
  # s.authors            = { "Sun Shijie" => "ssjlife0111@163.com" }
  # s.social_media_url   = "http://twitter.com/Sun Shijie"
